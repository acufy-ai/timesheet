...
class Settings(BaseModel):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://timesheet_user:__DB_PASSWORD__@localhost:5432/timesheet_db",
    ...
    control_database_url: str = Field(
        default="postgresql+asyncpg://timesheet_user:__DB_PASSWORD__@localhost:5432/acufy_control",
