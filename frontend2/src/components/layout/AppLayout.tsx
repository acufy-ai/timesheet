...
export const AppLayout: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      {/* Aurora sits behind everything (fixed, z:0 via #bgAurora rules).
          The body has bg-background applied via @layer base, so the Aurora
          paints over that base color. Layout containers below stay on z:10
          so the existing TopNavBar/Sidebar/Outlet shape is unchanged. */}
      <Aurora />
      <ScrollProgress />
